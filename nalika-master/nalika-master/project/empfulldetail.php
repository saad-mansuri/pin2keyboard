...
{
$str4="<font color='white'><h5><tr><td colspan='3'><br><img src='images/".$row4["empimg"]."' height='100'width='100'>".
...
<br>Gender:-".$row4["gender"]."
<center><a style='color:white' href='emporder.php?Id=".$row4['eId']."'>orders</a></center></td></tr></h5>
</font>";
}
