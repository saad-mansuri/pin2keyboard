...
{
	$str.="<tr><td><a href='catupdatee.php?Id=".$row['catId']."'><i class='fa fa-pencil'></i></a></td>
	<td><a href='CatDelete.php?Id=".$row['catId']."'><i class='fa fa-times'></a></td>
	<Td>".$row["catName"]."</td><td>".$row["catIsDisplay"]."</tr></td>";
}
$str.="</table>";
