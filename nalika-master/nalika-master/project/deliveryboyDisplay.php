...
<div class="col-lg-12">
                            <h1 class="page-header">Delivery boy</h1>
                        </div>
						
						
						
<div align="right">
<a href="DeliveryboyInsert.php">Insert</a>
</div>
...
{
	$str.="<tr><td><a href='deliveryboyupdate.php?Id=".$row['Did']."'>Update</a></td><td><a href='deliveryboyDelete.php?Id=".$row['Did']."'>Delete</a></td><Td>".$row["Duname"]."</td><td>".$row["Dfname"]."</td><td>".$row["Cnt"]."</td></tr>";
}
$str.="</table>";
