...
<div class="col-lg-12">
                            <font color="white"><h1 class="page-header">Category</h1></font>
                        </div>
...
{
	$str.="<tr><td><a href='catupdatee.php?Id=".$row['catId']."'>Update</a></td><td><a href='CatDelete.php?Id=".$row['catId']."'>Delete</a></td><Td>".$row["catName"]."</td><td>".$row["catIsDisplay"]."</tr></td>";
}
$str.="</table>";
