...
{
	$total+=$row['pq'];
	$str.="<tr><td>".$row["pName"]."</td><td>".$row["qty"]."</td><td>".$row["pPrice"]."</td><td>".$row["pq"]."</td>
	<td><img src='images/".$row["pimg"]."' height='100' width='100'>"."</td>"
	."</td><tr>";
}
$str.="</table>";
...
<div class="col-lg-4 col-md-12">
                               <center> <div class="grand-totall">
                                   
                                    <h2 class="grand-totall-title ">Grand Total : <span><?php echo $total ; ?></span></h2> 
