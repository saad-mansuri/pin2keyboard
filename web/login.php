                            ...
                            <form role="form" method="post">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Username" name="txtuname" type="Username" autofocus>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" class="btn btn-lg btn-success btn-block" value="Submit" name="btnSubmit">
                                </fieldset>
                            </form>
                        </div>
                    </div>
