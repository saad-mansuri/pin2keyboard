...
while($row=$result->fetch_assoc())
{
    $total+=$row['pq'];
	$str.="<tr>
	<td><a href='tempdelete.php?tid=".$row['tid']."'>delete</a></td>
...
$odate=date("Y-m-d");
$cnn=mysqli_connect("localhost","root","","dbproject");
$qry="insert into orders1(odate,eId) values('$odate','$eId')";
echo $qry;
$result=$cnn->query($qry);
...
$eId=$_SESSION["eid"];
$cnn=mysqli_connect("localhost","root","","dbproject");
$result=$cnn->query("SELECT amount FROM cmproleamount1 , employee1
